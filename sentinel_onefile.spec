...
"""PyInstaller ONE-FILE spec: bundles everything into a single SentinelSOC.exe.

Build with:  venv\Scripts\pyinstaller --noconfirm --clean sentinel_onefile.spec
Output:      dist\SentinelSOC.exe  (single file, ~220 MB)
