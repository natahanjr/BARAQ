...
SCENARIOS: list[dict[str, Any]] = [
    {
        ...
        "steps": [
            {"groups": [_group("g-inc-001a", ["h-inc-001"], ["T1078"], severity="low", alert_count=1)], "findings": []},
        ],
    ...
    },
    {
        ...
        "steps": [
            {"groups": [_group("g-inc-002a", ["h-inc-002"], ["T1110"], severity="high", alert_count=10)], "findings": [], "policy_id": "I003"},
        ],
    ...
    },
    {
        ...
        "steps": [
            {"groups": [_group("g-inc-003a", ["h-inc-003a"], ["T1133"]), _group("g-inc-003b", ["h-inc-003a"], ["T1021.001"])], "findings": [_finding("CF-inc-003", ["h-inc-003a"])]},
        ],
    ...
    },
    {
        ...
        "steps": [
            {"groups": [_group("g-inc-004a", ["h-inc-004"], ["T1059.001"])], "findings": [], "risks": [_risk("ER-inc-004", 72.0, severity="high", entity_id="h-inc-004")], "policy_id": "I002"},
        ],
    ...
    },
    {
        ...
        "steps": [
            {"groups": [_group("g-inc-005a", ["h-inc-005"], ["T1486", "T1490"])], "findings": [], "policy_id": "I006"},
        ],
        "expected": {"incident_created": True, "policy_id": "I006", "severity": "critical"},
    },
    {
        "id": "INC-006_LATERAL_MOVEMENT",
        "description": "Cross-host lateral movement creates an incident (7.4)",
        "steps": [
            {"groups": [_group("g-inc-006a", ["h-inc-006a"], ["T1021.001"]), _group("g-inc-006b", ["h-inc-006b"], ["T1021.001"])], "findings": [], "policy_id": "I004"},
        ],
    ...
    },
    {
        ...
        "steps": [
            {"groups": [_group("g-inc-007a", ["h-inc-007"], ["T1110", "T1552"])], "findings": [], "policy_id": "I005"},
        ],
    ...
    },
    {
        ...
        "steps": [
            {"groups": [_group("g-inc-008a", ["h-inc-008"], ["T1547", "T1543"])], "findings": [], "policy_id": "I007"},
        ],
    ...
    },
    {
        ...
        "steps": [
            {"groups": [_group("g-inc-009a", ["h-inc-009a"], ["T1059.001"])], "findings": [], "policy_id": "I003"},
            {"groups": [_group("g-inc-009b", ["h-inc-009b"], ["T1110"])], "findings": [], "policy_id": "I003"},
        ],
    ...
    },
    {
        ...
        "steps": [
            {"groups": [_group("g-inc-010a", ["h-inc-010"], ["T1021.001"])], "findings": [_finding("CF-inc-010", ["h-inc-010"])], "repeat": True, "policy_id": "I003"},
        ],
    ...
    },
    {
        ...
        "steps": [
            {"groups": [_group("g-inc-011a", ["h-inc-011"], ["T1021.001"])], "findings": [], "close_after": True, "policy_id": "I003"},
            {"groups": [_group("g-inc-011b", ["h-inc-011"], ["T1110"])], "findings": [], "policy_id": "I003"},
        ],
        "expected": {"incidents_created": 2},
    },
    {
        ...
        "steps": [
            {"groups": [_group("g-inc-012a", ["h-inc-012"], ["T1021.001"])], "findings": [], "suppress_after": True, "policy_id": "I003"},
            {"groups": [_group("g-inc-012a", ["h-inc-012"], ["T1021.001"])], "findings": [], "policy_id": "I003"},
        ],
    ...
    },
    {
        ...
        "steps": [
            {"groups": [_group("g-inc-013a", ["h-inc-013"], ["T1078"], severity="medium")], "findings": [], "policy_id": "I008"},
        ],
        "expected": {"incident_created": True, "policy_id": "I008", "severity": "medium"},
    },
    {
        "id": "INC-014_MULTI_HOST_SUPPORTED",
        "description": "Multi-host with correlation is eligible (7.27)",
        "steps": [
            {"groups": [_group("g-inc-014a", ["h-inc-014a", "h-inc-014b"], ["T1021.001"])], "findings": [_finding("CF-inc-014", ["h-inc-014a", "h-inc-014b"])], "policy_id": "I001"},
        ],
    ...
    },
    {
        ...
        "steps": [
            {"groups": [], "findings": [], "risks": [_risk("ER-inc-015", 90.0, severity="critical", entity_id="h-inc-015")]},
        ],
        "expected": {"incident_created": False},
    },
    {
        ...
        "steps": [
            {"groups": [_group("g-inc-016a", ["h-inc-016"], ["T1021.001"])], "findings": [_finding("CF-inc-016", ["h-inc-016"])], "policy_id": "I003"},
        ],
    ...
    },
    {
        ...
        "steps": [
            {"groups": [_group("g-inc-017a", ["h-inc-017"], ["T1021.001"])], "findings": [_finding("CF-inc-017", ["h-inc-017"])], "repeat": True, "policy_id": "I003"},
        ],
    ...
    },
    {
        ...
        "steps": [
            {"groups": [_group("g-inc-018a", ["h-inc-018"], ["T1021.001"])], "findings": [_finding("CF-inc-018", ["h-inc-018"])], "repeat": 3, "policy_id": "I003"},
        ],
        "expected": {"incidents_created": 1},
    },
    {
        ...
        "steps": [
            {"groups": [_group("g-inc-019a", ["h-inc-019"], ["T1021.001"])], "findings": [_finding("CF-inc-019", ["h-inc-019"])], "concurrent": True, "policy_id": "I003"},
        ],
        "expected": {"incidents_created": 1},
    },
    {
        ...
        "steps": [
            {"groups": [_group("g-inc-020a", ["h-inc-020"], ["T1486"])], "findings": [], "risks": [_risk("ER-inc-020", 85.0, severity="critical", entity_id="h-inc-020")], "policy_id": "I006"},
        ],
