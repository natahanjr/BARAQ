    ...
    try:
        ...
        if behavior == "login":
            ...
            enhanced_features = [
                ...
                min(_get_recent_events_count(session, "login", 24) / 100.0, 1.0),  # logins in last day (capped at 100)
        ...
        if behavior == "process":
            ...
            enhanced_features = [
                ...
                min(_get_recent_events_count(session, "process", 24) / 100.0, 1.0),  # processes in last day (capped at 100)
                _get_threat_intel_score(event),  # threat intelligence score
            ]
    ...
    def train(
        ...
        try:
            ...
            if len(network_X):
                ...
                network_y = np.array(
                    [
                        1 if str(r["remote_ip"]).startswith(_NET_ATTACK_PREFIXES)
                        else 0
